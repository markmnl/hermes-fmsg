...
The optional `hermes-fmsg` skill teaches Hermes how to install, verify,
operate, and troubleshoot this plugin safely. It does not replace the platform
plugin or handle message transport and credentials itself.

Install only this skill directly:
